  ...
  return (
    <div className="min-h-screen px-4 py-8 flex flex-col items-center">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-2xl font-bold text-white mb-6">🎯 Objective</h1>

        <div>
          <label className="text-white/70 text-sm mb-1 block">Career Objective</label>
          <textarea
            ...
            placeholder="Apna career objective yahan likho..."
          />
        </div>
